...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NamedCMSMenu.pages_json'
        db.add_column(u'named_cms_menus_namedcmsmenu', 'pages_json',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NamedCMSMenu.pages_json'
        db.delete_column(u'named_cms_menus_namedcmsmenu', 'pages_json')
